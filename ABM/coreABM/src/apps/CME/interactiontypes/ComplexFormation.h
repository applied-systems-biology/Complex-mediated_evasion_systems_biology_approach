...
#ifndef COREABM_COMPLEXFORMATION_H
#define COREABM_COMPLEXFORMATION_H

#include "core/simulation/interactiontypes/InteractionType.h"

class ComplexFormation :public InteractionType {
  public:
    // Class for 'Complex Formation' interaction

    ComplexFormation() = default;
...
#endif // COREABM_COMPLEXFORMATION_H
