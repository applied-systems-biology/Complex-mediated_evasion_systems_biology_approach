...
ComplexFormationInteraction::ComplexFormationInteraction(std::string identifier,
                                                       Cell *cell1,
                                                       Cell *cell2,
                                                       double time_delta,
                                                       double current_time) : Interaction(identifier,
                                                                                          ...
                                                                                          time_delta,
                                                                                          current_time) {
    // Here cell1 is always the other one than Defense
    setInitialState(time_delta, current_time, cell1);
}

std::string ComplexFormationInteraction::getInteractionName() const {
    return "ComplexFormationInteraction";
}