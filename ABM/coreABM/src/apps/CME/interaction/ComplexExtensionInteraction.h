...
#ifndef COREABM_COMPLEXEXTENSIONINTERACTION_H
#define COREABM_COMPLEXEXTENSIONINTERACTION_H
...
class ComplexExtensionInteraction : public Interaction {
  ...
  public:
    ...
    ComplexExtensionInteraction(std::string identifier,
                               Cell *cellOne,
                               Cell *cellTwo,
                               double time_delta,
                               double current_time,
...
#endif // COREABM_COMPLEXEXTENSIONINTERACTION_H
