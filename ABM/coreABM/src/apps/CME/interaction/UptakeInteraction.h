...
#ifndef COREABM_UPTAKEINTERACTION_H
#define COREABM_UPTAKEINTERACTION_H

#include <string>

#include "core/simulation/Interaction.h"

class UptakeInteraction : public Interaction {
  public:
    ...
    UptakeInteraction(std::string identifier,
                                Cell *cellOne,
                                Cell *cellTwo,
                                double time_delta,
                                double current_time);
...
#endif // COREABM_UPTAKEINTERACTION_H
