...
#ifndef CORE_SIMULATION_SimulatorCME_H
#define CORE_SIMULATION_SimulatorCME_H
...
class SimulatorCME : public Simulator {
   public:
    SimulatorCME() {};
    SimulatorCME(std::string config_path, std::unordered_map<std::string, std::string> cmd_input_args)
...
#endif  // CORE_SIMULATION_SimulatorCME_H
