...
CellState::CellState(const std::string &state_name, Cell *cell, std::map<std::string, Rate *> next_states) {
...
void CellState::addNextStateWithRate(const std::string &nameNextState, Rate *rate) {
...
void CellState::changeState(std::string stateName){
    current_state_ = stateName;
}